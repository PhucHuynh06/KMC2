    ...
    <div className='w-full xl:h-screen relative text-white'>
        ...
        <div className='xl:bg-main bg-dry flex-colo xl:bg-opacity-90 xl:absolute top-0 left-0 right-0 bottom-0'>
            <div className='container px-3 mx-auto 2xl:px-32 xl:grid grid-cols-3 flex-colo py-10 lg:py-20 gap-8'>
                <div className='xl:col-span-1 w-full xl:order-none order-last h-header bg-dry border border-gray-800'>
                    <img
                        src={movie?.titleImage ? `/images/${movie?.titleImage}` :"images/user.png"}
                        alt={movie?.name}
                            ...
                            <div className='sm:col-span-2 col-span-3 flex justify-end font-medium text-sm'>
                                ...
                                >
                                    <span className='flex items-center gap-4'>
                                        <FaPlay className='w-3 h-3'></FaPlay>Watch
                                    </span>
                                </Link>
                            </div>
                        </div>
                        ...
                        <button className='md:w-1/4 w-full relative flex-colo bg-subMain hover:bg-transparent border-2 border-subMain transitions md:h-64 h-20 rounded font-medium'>
                            <div className='flex-rows gap-6 text-md uppercase tracking-widest absolute md:rotate-90'>
                                <span className='flex items-center gap-6'>
                                    Download <FiLogIn className='w-6 h-6'></FiLogIn>
                                </span>
                            </div>
                        </button>
                    </div>
